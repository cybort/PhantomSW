...
{
public:
  typedef memory_storage_base* (*StorageCreator)(toplevel_memory_base&, const std::string& filename);
  ...
  memory_storage_base* create_storage(toplevel_memory_base& m,const std::string& filename);
